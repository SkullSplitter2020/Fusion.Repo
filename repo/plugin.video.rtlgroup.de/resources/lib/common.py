...
LICENSE_URL					= 'https://widevine.tvnow.de/index/proxy|{}&x-auth-token={}&Content-Type=text/html|{}|'
# https://widevine.tvnow.de/index/livestream || https://widevine.tvnow.de/index/license || https://widevine.tvnow.de/index/rtlplus
...
def get_userAgent(REV='128.0', VER='128.0'):
...
def ADDON_operate(IDD, check_2='undone'):
