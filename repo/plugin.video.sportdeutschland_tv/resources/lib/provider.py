...
class Client(object):
	CONFIG_SPORTDEUTSCHLAND = {
		...
		'TEAM_LIVENEXT': 'https://api.sportdeutschland.tv/api/web/public/profiles/{}/next-livestreams?',
		'HOME_TOPS': 'https://api.sportdeutschland.tv/api/stateless/frontend/top-profiles?',
		'TAGS_TOPS': 'https://api.sportdeutschland.tv/api/stateless/frontend/tags/{}/top-assets?',
		'TEAM_TOPS': 'https://api.sportdeutschland.tv/api/web/public/profiles/{}/top-assets?',
		'HOME_ASSETS': 'https://api.sportdeutschland.tv/api/web/public/home?',
		'TAGS_ASSETS': 'https://api.sportdeutschland.tv/api/stateless/frontend/tags/{}/assets?',
		'TEAM_ASSETS': 'https://api.sportdeutschland.tv/api/web/public/profiles/{}/assets?',
