...
FAVORIT_FILE						= xbmcvfs.translatePath(os.path.join(dataPath, 'favorites_SETV.json'))
...
IMG_categories					= 'https://img.sporteurope.tv/{}/300x300.webp'
IMG_assets							= 'https://img.sporteurope.tv/{}/1920x1080.webp'
API_PLAYER						= 'https://api.sporteurope.tv/api/web/personal/asset-token/'
API_LOGINS						= 'https://api.sporteurope.tv/api/web/auth/login'
API_LOGOUT						= 'https://api.sporteurope.tv/api/web/auth/logout'
BASE_URL							= 'https://sporteurope.tv/'
...
traversing							= Client(Client.CONFIG_SPORTEUROPE)
...
def create_entries(metadata, SIGNS=None):
	...
	if KODI_ov20: vinfo.setStudios(['Sporteurope.tv'])
	else: vinfo['Studio'] = 'Sporteurope.tv'
